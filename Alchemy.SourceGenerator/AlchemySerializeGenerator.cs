...
{{
    ...
    {{
        this.{fieldName} = global::Alchemy.Serialization.Internal.SerializationHelper.FromJson<{field.Type.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat)}>({alchemySerializationDataName}.{fieldName}.data, {alchemySerializationDataName}.UnityObjectReferences);
    }}
}}
catch (global::System.Exception ex)
{{
